...
const About = () => {
  return (
    <div className="d-flex flex-column my-5 align-items-center minheight">
      ...
      <h3 className="fw-bold">Jahidul Islam</h3>
      ...
      <div className="border-top border-4 mt-3 border-dark ">
        ...
        <p className="text-center my-3">
          Assalamualikum, I'm Jahidul Islam .I completed my graduation form
          Weifang University of Science and Technology last year. Now I am currently walking
